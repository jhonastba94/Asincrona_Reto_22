...
const routes: Routes = [
  ...
  {path:'perfil/:name/:lastname/:email', component:ProfileComponent, title:'Perfil', canActivate:[CanActivateGuard],canDeactivate:[DeactivateGuard]},
  {path:'perfil', component:ProfileComponent, title:'Perfil', canActivate:[CanActivateGuard],canDeactivate:[DeactivateGuard]},

  {path:'**', component:NotFoundComponent, title: 'Pagina no encontrada', canActivate:[CanActivateGuard]}
];
